...
/**
 * Validates the exact authority-visible record body supported by profile v1.
 * The invariant is the UTF-8 encoding of this string, not the complete
 * frontmatter-bearing Markdown document. Profile v1 admits LF line endings
 * only and deliberately performs no Unicode normalization.
 */
