...
export const CONNECT_SCHEMA_IDS = {
  ...
  appManifestV3: "https://mdbase.dev/connect/schemas/mdbase-app.v3.json",
...
/**
 * A declaration bundled with an application build and registered inline.
 *
 ...
 */
export interface MdbaseAppManifestV3 {
  manifest_version: 3;
  id: string;
  name: string;
  homepage: string;
