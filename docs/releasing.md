...
```bash
pnpm version:check v0.1.0-beta.3
git branch releases/v0.1.0-beta.3
git tag -a v0.1.0-beta.3 -m "mdbase connect 0.1.0-beta.3"
git push origin releases/v0.1.0-beta.3 v0.1.0-beta.3
```
