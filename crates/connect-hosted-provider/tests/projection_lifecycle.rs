...
async fn projection_index_plan_requires_exact_embedded_migration_inventory() {
    ...
    for (name, corruption) in [
        ...
        ("extra", "INSERT INTO _sqlx_migrations SELECT 999999, description, installed_on, success, checksum, execution_time FROM _sqlx_migrations WHERE version = 41"),
        ...
        ("right count wrong future version", "UPDATE _sqlx_migrations SET version = 999999 WHERE version = 41"),
