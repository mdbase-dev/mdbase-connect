...
fn pending_mutation_response(keys: &RelayKeys, metadata: RelayMetadata<'_>) -> RelayMessage {
...
fn serialized_encrypted_response(serialized: &str, request_id: uuid::Uuid) -> RelayMessage {
