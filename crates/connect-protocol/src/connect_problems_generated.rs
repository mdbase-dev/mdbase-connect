...
pub fn connect_problem_definition(code: &str) -> Option<ConnectProblemDefinition> {
    match code {
        ...
        "first_contact_handler_required" => Some(ConnectProblemDefinition { category: ConnectProblemCategory::Compatibility, recovery: ConnectRecoveryAction::UpgradeApplication }),
        ...
        "invalid_first_contact" => Some(ConnectProblemDefinition { category: ConnectProblemCategory::Integrity, recovery: ConnectRecoveryAction::ContactSupport }),
