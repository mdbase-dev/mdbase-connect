...
// Rows the usage report reads are linked to an account. They are kept for a
// bounded window after they stop mattering to authorization, then deleted.
// Account deletion still cascades immediately.
export const USAGE_RETENTION_DAYS = 395;

interface UsageRetentionResult {
